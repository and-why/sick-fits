...
class UserPermissions extends Component {
  ...
  handlePermissionChange = (e, updatePermissions) => {
    ...
    // figure out if we need to add it in or remove this
    if (checkbox.checked) {
      // add it in
    ...
    this.setState(
      ...
      //call updatePermission as the callback for updading state.
      updatePermissions,
    );
  };
                ...
                <td key={permission}>
                  <label htmlFor={`${user.id}-permission-${permission}`}>
                    <input
                      ...
                      value={permission}
                      // handle change and expose access to another function
